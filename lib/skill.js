			...
			cast: function() {
				...
				ap.game.createFlyer({
					...
					anims: new ap.Animation([
						new ap.Image("media/effect/fireball.png", {
							x: 65,
							y: 24
						}, 0, 0, 90, 50),
						new ap.Image("media/effect/fireball.png", {
		...
		disintegrate: {
			...
			cast: function() {
				...
				ap.game.createFlyer({
					...
					moveSpeed: 500,
					anims: new ap.Animation([
						new ap.Image("media/effect/fireballBig.png", {
							x: 130,
							y: 48
						}, 0, 0, 180, 100),
						new ap.Image("media/effect/fireballBig.png", {
		...
		incinerate: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					coolDown: 0.16,
					anims: new ap.Animation([new ap.Image("media/effect/flame.png", {
						x: 0,
						y: 105
					})])
				});
		...
		throwing: {
			...
			cast: function() {
				...
				ap.game.createFlyer({
					...
					moveAim: this.caster.aim,
					anims: new ap.Animation([
						new ap.Image("media/effect/throwing.png", {
							x: 13,
							y: 15
						})
					])
		...
		fight: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					coolDown: 0.15,
					anims: new ap.Animation([new ap.Image("media/effect/fight.png", {
						x: 0,
						y: 10
					})])
				});
			...
			cast: function() {
				...
				for (var i = 0; i < 5; i++) {
					ap.game.createFlyer({
						...
						anims: new ap.Animation([
							new ap.Image("media/effect/fire.png", {
								x: 84,
								y: 16
							})
						])
		...
		miasma: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					status: status,
					coolDown: 0.1,
					animSheet: new ap.Image("media/effect/miasma.png", {
						x: 150,
						y: 150
					})
				});
		...
		prison: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					coolDown: 0.1,
					once: true,
					animSheet: new ap.Image("media/effect/prison.png", {
						x: 25,
						y: 20
					})
				});
		...
		cold: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					coolDown: 0.1,
					once: true,
					animSheet: new ap.Image("media/effect/cold.png", {
						x: 25,
						y: 20
					})
				});
		...
		annihilation: {
			...
			cast: function() {
				...
				ap.game.createArea({
					...
					aimE: this.caster.aim + this.rad / 2,
					coolDown: 1.4,
					anims: new ap.Animation([new ap.Image("media/effect/Annihilation.png", {
						x: 0,
						y: 300
					}), new ap.Image("media/effect/Annihilation1.png", {
						x: 0,
						y: 300
					})], 1.4)
				});
		...
		bearAttack: {
			...
			cast: function() {
				ap.game.createArea({
					...
					aimE: this.caster.aim + this.rad / 2,
					coolDown: 0.2,
					anims: new ap.Animation([new ap.Image("media/effect/bearAttack.png", {
						x: 0,
						y: 100
					})])
				});
